package com.shishodia.kafka.libraryeventsproducer.config;
...
public class AutoCreateConfig {
    ...
    /**
     * Used to create new topic using code. Broker list is fetched from `spring.kafka.admin.bootstrap.servers`.
